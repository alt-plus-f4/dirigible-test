...
export class PetsRepository {
    ...
    private async triggerEvent(data: PetsEntityEvent | PetsUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("pet-store-entities-Pets", ["trigger"]);
        ...
        producer.topic("pet-store-entities-Pets").send(JSON.stringify(data));
    }
}
